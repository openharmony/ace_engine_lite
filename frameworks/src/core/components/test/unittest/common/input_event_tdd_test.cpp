...
const char BUNDLE7[] =
    ...
    "                'staticClass' : ['button']}),\n"
    "            _c('input',{ 'attrs' : {'type' : 'radio', 'show': function() { return _vm.radioStatus; }, 'ref': 'radio'},\n"
    "                'staticClass' : ['radio']}),\n"
    "            _c('input', {'attrs' : {'type' : 'button','value' : 'changeShow'},\n"
...
const char BUNDLE10[] =
    ...
    "                }),\n"
    "      _c('input', {'attrs': {'type': 'checkbox', 'checked': false, 'value': 'check', 'name': 'input2', 'ref':'checkbox'},\n"
    "                   'staticClass': ['checkbox'],\n"
    "                   'staticStyle': {'left': '30%', 'top': '60%'},\n"
    "                   'onBubbleEvents': {'change': _vm.changeCheckbox}}),\n"
    "      _c('input', {'attrs': {'type': 'radio', 'checked': false, 'value': 'radio', 'name': 'input3', 'ref': 'radio'},\n"
    "                   'staticClass': ['radio'],\n"
    "                   'staticStyle': {'left': '30%', 'top': '80%'},\n"
...
void InputEventTddTest::ClickPosition(const double xRate, const double yRate)
{
...
UIView *InputEventTddTest::GetComponent(JSValue page, const char *name)
{
