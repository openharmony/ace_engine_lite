...
private:
    ...
    void SetDragStartEventListener(UIView& view, jerry_value_t eventFunc, bool isStopPropagation);
    void SetDragEventListener(UIView& view, jerry_value_t eventFunc, bool isStopPropagation);
    void SetDragEndEventListener(UIView& view, jerry_value_t eventFunc, bool isStopPropagation);
    ...
    ViewOnDragListener *onDragListener_;
#ifdef JS_TOUCH_EVENT_SUPPORT
